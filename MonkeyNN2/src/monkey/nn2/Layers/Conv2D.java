...
public class Conv2D extends Layer {
	...
	public Shape<Float> feed(Shape<Float> input) {
		...
		Matrix3D<Float> outShape = new Matrix3D<Float>(new int[] {cZ, (cX - kernels.getSize()[1] + 1) / stride[0], (cY - kernels.getSize()[2] + 1) / stride[1]});
	...
	public void setKernel(Matrix3D<Float> kernel) {
		kernels = kernel;
	}
	
	public Matrix3D<Float> getKernel() {
		return kernels;
	}
